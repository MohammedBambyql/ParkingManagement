...
namespace ParkingManagement.Controllers
{
    public class ParkingSpotsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SpotId,Type,IsOccupied")] ParkingSpot parkingSpot)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SpotId,Type,IsOccupied")] ParkingSpot parkingSpot)
        {
